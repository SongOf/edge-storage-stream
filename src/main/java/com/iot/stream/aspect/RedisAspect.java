package com.iot.stream.aspect;

import com.iot.stream.annotation.RedisCache;
import com.iot.stream.annotation.RedisEvict;
import com.iot.stream.utils.RedisUtils;
...
public class RedisAspect {
     ...
     */
    @Pointcut("@annotation(com.iot.stream.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.iot.stream.annotation.RedisEvict)")
